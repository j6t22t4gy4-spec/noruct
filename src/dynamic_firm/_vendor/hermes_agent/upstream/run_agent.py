...
def attach_noruct_company_context(agent, context=None):
    """Insert Noruct's data-only Company projection into this agent fork."""

    from noruct_firm import attach_company_context

    attach_company_context(agent, context)
